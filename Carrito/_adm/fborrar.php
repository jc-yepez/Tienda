...
mysql_select_db($database_conexion, $conexion);
$query_rsEliminar = sprintf("SELECT * FROM productos WHERE codigo_producto = %s ORDER BY nombre ASC", $colname_rsEliminar);
...
.Estilo5 {color: #FFFFFF; font-size: 14px; }
 ...
 <tr>
	...
	<form id="form1" name="form1" method="post" action="">
	  <p><label></label>
          <label></label>
          <label></label></p>
        <table width="304" height="117" border="0" bgcolor="#3366CC">
          <tr>
            <td><span class="Estilo5">
              <label>              </label>
            </span>              <span class="Estilo4">
            <label></label>
            </span>            <label><div align="right" class="Estilo5">C&oacute;digo:</div>
            </label></td>
            <td><span class="Estilo6"><?php echo $row_rsEliminar['codigo_producto']; ?></span></td>
          </tr>
          <tr>
            <td><div align="right" class="Estilo5">Nombre:</div></td>
            <td><span class="Estilo6"><?php echo $row_rsEliminar['nombre']; ?></span></td>
          </tr>
          <tr>
            <td colspan="2"><div align="center" class="Estilo1">&iquest;Est&aacute; seguro de eliminar?</div></td>
          </tr>
          <tr>
            <td height="28">
              <div align="right">
    ...
    <td width="50"><img src="../imagenes/mm_spacer.gif" alt="" width="50" height="1" border="0" /></td>
		...
		<table border="0" cellspacing="0" cellpadding="0" width="190">
			...
			<td width="110" id="sidebar" class="smallText"><p align="center"><img src="../imagenes/mm_travel_photo1.png" alt="Image 1" width="110" height="110" vspace="6" border="0" /><br />
