...
if (isset($_POST['txtUsuario'])) {
  ...
  $MM_redirectLoginFailed = "fusuariosMal.php";
...
<br />
	...
	<table width="312" border="0">
      <tr>
        <td width="306"><div align="right"><img src="../imagenes/btn_Compra_Oline.png" alt="s" width="174" height="65" /></div></td>
      </tr>
    </table>
	<p><br />
  &nbsp; <span class="Estilo2">Bienvenido a la compra on-line, para disfrutar de este servicio debe inciar sesi&oacute;n o registrarse. </span></p>
	<p class="Estilo2">A traves de esta opci&oacute;n acceder&aacute; al formulario para convertirse en cliente del Supermercado.</p>
	<form id="form1" name="form1" method="POST" action="<?php echo $loginFormAction; ?>">
	  <table width="200" height="102" border="0" bgcolor="#3366CC">
        <tr>
          <td height="24"><div align="left" class="Estilo4">Usuario </div></td>
          <td><label>
        ...
        <tr>
          <td height="37"><div align="left" class="Estilo4">Clave            </div></td>
          <td><label>
	...
	<div align="center"><span class="Estilo1">USUARIO INCORRECTO INTENTE DE NUEVO </span><br />
	</div></td>
    <td width="50"><img src="../imagenes/mm_spacer.gif" alt="" width="50" height="1" border="0" /></td>
