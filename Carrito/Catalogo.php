...
$query_rsProductos = "SELECT * FROM productos ORDER BY nombre ASC";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="305">
        <tr>
          <td class="pageName">CATALOGO DE PRODUCTOS </td>
		</tr>
	...
	<table width="200" border="1">
      ...
      <?php do { ?>
        <tr>
          ...
          <td><img src="<?php echo $row_rsProductos['foto']; ?>" width="100" height="100" /></td>
          <td><a href="modificar.php?codigo=<?php echo $row_rsProductos['codigo_producto']; ?>"><img src="imagenes/mod.png" width="54" height="50" border="0" /></a></td>
          <td><a href="eliminar.php?cod=<?php echo $row_rsProductos['codigo_producto']; ?>"><img src="imagenes/delete.png" width="81" height="81" border="0" /></a></td>
        </tr>
