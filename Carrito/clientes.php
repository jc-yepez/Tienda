...
$MM_authorizedUsers = "Asistente,Administrador";
...
$query_rsClientes = "SELECT * FROM clientes";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="165" id="navigation">
        ...
        <tr>
          <td><a href="usuarios.php" class="navText">Usuarios</a></td>
        </tr>
        <tr>
    ...
    <td width="305" colspan="2" valign="top"><div align="right"><img src="imagenes/mm_spacer.gif" alt="" width="305" height="1" border="0" /><br />
      &nbsp;<a href="_adm/IngresoClientes.php"><br />
      Nuevo Cliente</a> &nbsp;
    </div>
	  ...
	  <table width="310" border="1">
        ...
        <?php do { ?>
          <tr>
              <td><?php echo $row_rsClientes['CED_CLI']; ?></td>
            <td><?php echo $row_rsClientes['NOM_CLI']; ?></td>
            <td><?php echo $row_rsClientes['APE_CLI']; ?></td>
            <td><?php echo $row_rsClientes['DIR_CLI']; ?></td>
            <td><?php echo $row_rsClientes['EMAIL_CLI']; ?></td>
            <td><?php echo $row_rsClientes['TEL_CLI']; ?></td>
            <td><img src="<?php echo $row_rsClientes['IMA_CLI']; ?>" alt="cliente" width="100" height="100" /></td>
          </tr>
